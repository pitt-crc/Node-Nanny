...
class CLIParser(ArgumentParser):
    ...
    def __init__(self):
        ...
        # Command subparser
        command = self.add_subparsers(dest='command',help='subcommand to run. Options are scan, kill, whitelist, add, remove')
        ...
        kill.add_argument('-q', '--quiet', action='store', type=boolean, required=False, help='suppress outgoing email notifications') 
        ...
        node_opts.add_argument('-g', '--global', action='store_true', const=True, type=bool, default=False, help='Whitelist user on all nodes')
        ...
        node_opts.add_argument('-g', '--global', action='store_true', const=True, type=bool, default=False, help='Un-Whitelist user on all nodes')
